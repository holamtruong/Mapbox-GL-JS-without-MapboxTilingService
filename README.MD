...
In December 2020, the Mapbox GL JS license change sent shock waves through the web mapping industry. In essence, the new library version Mapbox GL JS v2 is not free anymore. [ mapbox-gl-j v2.0.0](https://github.com/mapbox/mapbox-gl-js/releases/tag/v2.0.0), a billable map load occurs whenever a Map object is initialized. Before updating an existing implementation from v1.x.x to v2.x.x. This is a simple way to remove the Mapbox Vector Tiles API serves vector tiles or paying for tiles. 
